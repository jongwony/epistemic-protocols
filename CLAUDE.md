...
- **Key**: Phase 0 calls `AskUserQuestion` for Mission Brief confirmation; Phase 2 for perspective selection; Phase 5 for sufficiency check with `act` option; Phase 6-7 classify findings and execute fixes with peer verification; loop until user satisfied or ESC
