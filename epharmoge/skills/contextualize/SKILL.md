...
ApplicabilityVerdict = { target: R_final, dispositions: List(DispositionRecord), unresolved: Set(Mismatch), scan_count: Nat, carrier: Option(EntryLocator) }
         ...
         --                  Phase 0 → confirm_no_mismatch / deactivate, or the ESC exit)
