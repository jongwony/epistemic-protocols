...
19. **TACC family awareness** (Tool-Aligned Cognitive Compromise): Post-execution applicability checks inherit cognitive-cost homogeneity — bundle context-mismatch surfacings of comparable cost per round, fork single high-cost mismatch decisions to focused rounds.
