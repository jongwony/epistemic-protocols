...
Analysis, evidence, rationale as text output before the gate; the gate contains the essential question and option-specific differential implications only.
