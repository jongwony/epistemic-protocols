...
**Cross-session enrichment**: Prior session indices from the hypomnesis store, when present, may seed the Phase 0 uncertainty scan; the constitutive judgment remains with the user.
