...
| Non-actionable transparency | Uₙ items show as out-of-scope in Phase 2 classify summary | User sees these fall outside Aitesis's resolution rather than being silently dropped |
