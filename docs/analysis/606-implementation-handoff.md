...
**§11-①~④ 전 4건 확정됨 (계획 §12, 2026-07-12)** — 아래 표는 원 미결 상태를
이력으로 보존하고, 각 행에 확정값과 계획 문서 포인터를 덧붙인다. 착수 중단
사유였던 명명 미확정은 해소되었다: 디렉터리·파일명은 `skills/preview/`로
확정되었으므로 §10-①부터 중단 없이 진행한다.

| 항목 | 후보 | 결정 권한과 미확정 시 행동 | 확정값 (계획 §12) |
|---|---|---|---|
