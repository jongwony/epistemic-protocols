# Matt Pocock Skills의 현상학/확장인지적 Grounding

> 이 문서는 `../../oss/skills`에 클론된
> [`mattpocock/skills`](https://github.com/mattpocock/skills)의 지침을
> 형식적 skill-to-protocol 대응표가 아니라, 지침이 전제하는 철학의 관점에서
> 분석한다. 중심 질문은 다음이다: Matt Pocock의 "small, composable skills"는
> 인간-AI 협업에서 어떤 인지적 관계를 보존하려 하는가?
...
- `../../oss/skills/README.md`: "real engineering", control 보존,
  small/composable skills, misalignment, shared language, feedback loop.
- `../../oss/skills/skills/engineering/diagnose/SKILL.md`: feedback loop를
  debugging의 핵심으로 둔다.
- `../../oss/skills/skills/engineering/tdd/SKILL.md`: public interface를 통한
  behavior verification과 vertical red-green loop.
- `../../oss/skills/skills/engineering/grill-with-docs/SKILL.md`: glossary,
  ADR, code cross-reference를 통한 shared language 갱신.
- `docs/philosophical-anchors.md`: relay/constitution boundary, Extended Mind,
  Epistemic Cost Topology, Anamnesis의 recognition grounding.
- `docs/analysis/horismos-philosophical-foundations.md`: BoundaryMap과 common
  ground, transactive memory, cognitive labor 분배.
...
- [`mattpocock/skills`](https://github.com/mattpocock/skills): 원 repo README와
  skill 설명.
- [MIT Press, *The Extended Mind*](https://mitpress.mit.edu/9780262014038/the-extended-mind/):
  Clark & Chalmers의 active externalism과 환경의 인지적 역할.
- [Stanford Encyclopedia of Philosophy, Edmund Husserl](https://plato.stanford.edu/entries/husserl/):
  Husserl의 intentionality, temporality, constitution 배경.
