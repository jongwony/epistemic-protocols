...
- Coverage: present in all protocol SKILL.md files except anagoge (`anagoge/skills/ascend/SKILL.md` carries no COMPOSITION block), with identical text across the files that carry it
