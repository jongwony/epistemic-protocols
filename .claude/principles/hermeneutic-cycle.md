...
**Gated interaction realization**: full text (relocated from `.claude/rules/axioms.md` A5, 2026-07-28, and now further relocated) — `premise/recognition-and-authority.md` §Gated Interaction Realization. It extends Recognition over Recall to gated interactions — the same Recognition-over-Recall move that grounds this surface's horizon-fusion point above.
