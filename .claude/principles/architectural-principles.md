...
Operational test: "Is the resistance to this refactor grounded in accumulated work, or in observed structural deficit?" Former → this principle applies (proceed). Latter → halt and investigate. When both grounds co-occur, the structural deficit arm dominates: halt regardless of accumulated work investment.
