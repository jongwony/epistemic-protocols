...
The promotion/demotion decision follows an iterative pattern (phase names retained as inherited terminology from the prior "Hermeneutic Circle Evolution Model" framing per #240 partial closure):
