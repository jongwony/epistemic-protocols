...
> **Demoted detail**: Stage 1 / Stage 2 specifications (compile conditions, runtime corroboration, retraction operationalization, anti-inflation clause, operational tests) and the Axiomatization Judgment Framework (Core Principle, Promotion Criteria, Demotion Criteria, Hermeneutic Circle Evolution Model, Tension-Accumulation Threshold) live in `.claude/principles/meta-principle.md` per Tier Factorization o-tier classification (T2-T3, axiom-evolution time invocation). Fetch via Read/Grep when authoring new axioms/protocols or evaluating tier reclassification. Promotion back to this file is governed by Stage 2 use corroboration; see `.claude/principles/README.md` for the demotion ledger.
