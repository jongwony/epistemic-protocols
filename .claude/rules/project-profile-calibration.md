...
Telos / Horismos / Syneidesis are also grounded by their respective protocol-internal `always_gated` checkpoints — GoalContract Phase 2, boundary approval Phase 4, gap consideration Phase 3 — providing direct A2 enforcement at the protocol layer. Profile-layer enumeration of these protocols is therefore redundant for runtime enforcement; their inclusion in the bounded zone is for **future ELIDABLE CHECKPOINTS migration visibility**, not present runtime gating.
