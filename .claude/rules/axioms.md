...
- **Constitution (constitutive mode)**: AI exercises epistemic authority through selection, interpretation, scope expansion, or environment mutation. User confirmation required.
...
| Indicator | Extension (relay) | Constitution (gated) |
|-----------|-------|-------------|
