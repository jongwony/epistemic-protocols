...
- Merismos `/apportion`: obligation reading, apportionment search, horizon-fit and seam-quality judgment, condition derivation, and the compile-time gates are epistemic substrate; predicate enforcement inside each execution interval, pre-action interception of the out-of-scope obligations, workflow/HITL semantics, and concrete executor binding are non-epistemic substrate, delegated by handoff at emission.
