...
- **framing-readout-enforcement** — completion bars were observed on the core protocol surfaces and in the Ink bodies, which is what admitted a guard here at all. Its kernel is the Cognitive work element's own positive statement of what it is rather than a prohibition, because that body is injected every turn and is therefore runtime motivating prose under `premise/instruction-authoring.md` §Prohibition Base Rate and White Bear Avoidance.
