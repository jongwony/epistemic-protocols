...
**Mode 2 (inquire) only.** Mode 1 (recommend) terminates at LensEstablished, before Phase 4 (inquiry) — no inquiry execution occurs (it also skips the new Phase 3 Deliberation Design). See Rule 3.
