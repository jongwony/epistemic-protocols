...
**Cross-session enrichment**: Prior framing experiences accumulated in MEMORY.md or .insights/ through prior Reflexion cycles may guide Phase 2 perspective generation — previously effective analytical lenses for similar domains provide starting hypotheses. This is a heuristic input; gate judgment remains with the user.
