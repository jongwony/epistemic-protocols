...
| [Hyphegesis](./hyphegesis) | `/conduct` | Multiple cognitive moves whose order, independence, reconciliation, stopping, and routing aren't obvious — conduct how the whole session's work runs before starting |
