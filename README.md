...
| **[Epitrope](./epitrope)** (ἐπιτροπή) — /calibrate | Calibrate delegation autonomy through scenario interview | Pre-execution |
...
/calibrate [your task]        # Calibrate delegation autonomy through scenario interview
```
