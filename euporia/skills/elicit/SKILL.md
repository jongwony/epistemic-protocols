...
4. **Convergence persistence**: as typed by the closed deactivation-condition set in the Mode Deactivation table.
...
13. **Seam relay on declared continuation**: as typed by the "Seam transition to declared next protocol (extension)" entry in TOOL GROUNDING.
