...
**Scope restriction**: Traversal uses artifact read and artifact search exclusively. Cross-partition reads only — never cross-slug writes; Anagoge writes nothing.
