...
ἀναγωγή("끌어올림")는 ἀνάμνησις의 의도된 형제어입니다. ana-mnesis가 *하나의* 과거 맥락을 회상한다면, ana-goge는 그 회상을 그 위의 연결된 단위로 *끌어올립니다*. 중세의 anagogical 독법 — 문자적인 것을 궁극적 통일성으로 들어올리는 읽기 — 이 구조적 비유를 제공합니다. deposit이 문자적인 것이고, 상위 단위가 그것들이 가리키는 통일성입니다. 본 프로토콜은 그 끌어올림 구조를 차용할 뿐, 어떤 주석학적 교리도 주장하지 않습니다.
...
Phase 2: Recognize   → SingleObvious면 게이트 없이 내러티브를 바로 emit (침묵 = 인지); 그 외에는 상위 단위 후보를 인지를 위해 내러티브로 제시 (gate interaction)
