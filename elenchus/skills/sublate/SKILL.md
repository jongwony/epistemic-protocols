...
14. **TACC family awareness** (Tool-Aligned Cognitive Compromise): Per-source vetting interactions inherit cognitive-cost homogeneity heuristic — bundle confidence-homogeneous source claims per cycle, fork single high-cost vetting decisions to focused rounds.
