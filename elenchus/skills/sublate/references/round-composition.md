...
Each source's content, the claim it is read as authority for, the tagging triple, the pattern with its thesis and antithesis, the basis cited for that antithesis, and the deficit-fit basis all appear as text output PRECEDING the Constitution interaction — analysis, evidence and rationale sit before the gate, never inside it. The interaction itself carries the open question and the instruction list with each instruction's differential implication, and nothing else. No answer is offered there: what the claim IS stays the user's to say in their own words.
