...
| Grounds located, but an entailment to any conclusion the answer asserts is contestable or was never offered, a material premise is interpretive, a source the precommit named went untouched, or the stated falsifier could not have defeated the reading | **indeterminate (audit)** | Unfold everything, naming what the answer did not reach |
