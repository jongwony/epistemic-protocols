...
| Grounds located, but an entailment to any conclusion the answer asserts is contestable or was never offered, a material premise is interpretive, a source the precommit named went untouched, a criterion the precommit set goes unmet, a proposed repair arrives without what it changes, or the stated falsifier could not have defeated the reading | **indeterminate (audit)** | Unfold everything, naming what the answer did not reach |
