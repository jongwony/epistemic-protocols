...
An HFT file has exactly four layers, identified by H2 headings and ordered as below. The order is normative — readers parse top-down and the order encodes priority (Surface Text first because it is the primer; Reference Shells last because they are auxiliary).
