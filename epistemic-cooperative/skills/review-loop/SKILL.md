...
11. **The driving session reads its own trajectory by regime and by re-flagging, never by
    ...
    regime under a different name, and courts the same manufactured approve Rule 9
    forbids (PR #637).
