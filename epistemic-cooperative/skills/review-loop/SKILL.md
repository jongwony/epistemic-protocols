...
- the source verdict converges to `approve` and no finding it still surfaces is a recurrence awaiting diagnosis (an approve verdict does not skip recurrence diagnosis), OR
