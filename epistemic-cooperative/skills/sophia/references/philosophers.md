...
- **Protocol affinity**: `/apportion` (Merismos — apportioning a goal into units before handing execution to an autonomous run extends cognition into the delegated system, Clark's core thesis)
