...
| Bash contains deploy/push/apply keywords | Bash input keyword match | **Merismos** `/apportion` | Risky execution without compiled guardrail conditions |
...
|---|---|---|---|
| Many hook configurations | settings.json hooks | **Merismos** `/apportion` (reinforcing) | User already values safety mechanisms |
...
| `wrong_file_edited` | **Merismos** `/apportion` | Execution boundaries not compiled into verifiable conditions | Primary |
