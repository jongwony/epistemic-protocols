...
| `/place` | Placement audit — routes each decision-bearing clause of instruction prose to one of six destinations (three load tiers, enforcement, ledger, delete) | JSON routes (read-only) |
