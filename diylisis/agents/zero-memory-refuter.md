...
- `activation`: the activation edge under review — the verb and locator that hands the artifact to the recipient (the minimal admissible edge is "Read `<locator>` and execute it"). Review it together with the handoff under the minimal admissible edge; see checklist category 8.
