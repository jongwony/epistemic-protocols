...
7. **Convergence persistence**: as typed by the closed deactivation-condition set in the Mode Deactivation table.
...
17. **Seam relay on declared continuation**: as typed by the "seam (extension)" entry in TOOL GROUNDING.
