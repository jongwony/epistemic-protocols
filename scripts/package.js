...
Static checks validate protocol integrity before every commit. Run \`node .claude/skills/verify/scripts/static-checks.js .\`; the script itself is the current check inventory.
