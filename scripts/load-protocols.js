...
const CANONICAL_PRECEDENCE = [
  ...
  'Analogia', 'Periagoge', 'Euporia', 'Heuresis', 'Proplasma', 'Hypotyposis',
  'Merismos', 'Epharmoge', 'Elenchus', 'Hyphegesis',
];
...
const CANONICAL_CLUSTERS = 'Planning (`/inquire`, `/elicit`, `/ideate`, `/preview`, `/sketch`) · Analysis (`/frame`, `/ground`, `/induce`) · Execution (`/apportion`) · Verification (`/contextualize`, `/sublate`) · Cross-cutting (`/bound`, `/recollect`, `/grasp`, `/conduct`)';
