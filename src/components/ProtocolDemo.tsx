...
export const demoScenarios: DemoScenario[] = [
  ...
  },
  {
    ...
    userPrompt: "Run the schema migration autonomously and open a PR",
    phases: [
      { name: "Phase 0", description: "Boundary Inference" },
      { name: "Phase 1", description: "Velocity Partition" },
      { name: "Phase 2", description: "Condition Compilation" },
      { name: "Phase 3", description: "Emission + Handoff" },
    ],
    response: [
      { type: "label", text: "Phase 0\u21921 \u2014 Boundary Inference + Velocity Partition" },
      { type: "heading", text: "Boundary signals inferred from context, partitioned by velocity:" },
      { type: "question", text: "ScopeConfinement (Slow) \u2014 declared scope is db/migrations \u2192 compiles to a stop-time diff check" },
      { type: "question", text: "CompletionThreshold (Slow) \u2014 migration tests pass \u2192 compiles to an executable exit-status check" },
      { type: "question", text: "Irreversibility (Split) \u2014 no commits beyond the feature branch compiles Slow; destructive-command interception is Fast \u2192 out of scope, delegated to the harness permission gate" },
      { type: "gate", text: "Compiled guardrail set ready \u2014 Confirm / Adjust \u2192" },
      { type: "insight", text: "Guardrails are compiled before autonomy begins: every slow risk becomes a verifiable stop-time predicate; fast risks are delegated, never simulated." },
    ],
  },
  {
    protocol: "Epharmoge",
