...
**Cross-session enrichment**: Prior session indices from the hypomnesis store, when present, may seed the packing search toward cut granularities; the constitutive judgment remains with the user.
