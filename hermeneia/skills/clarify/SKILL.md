...
**Cross-session enrichment**: Accumulated clarification patterns (MEMORY.md, .insights/) from prior Reflexion cycles may improve ai_strong trigger precision — known intent-expression gaps in similar contexts reduce false positive detection. This is a heuristic input; gate judgment remains with the user.
