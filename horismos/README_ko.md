...
사용자는 어느 축이든 열어 잠정 내용을 살펴보고, 틀을 고친 뒤 맡길 수 있습니다. 축마다 살펴보는 깊이가 달라도 됩니다. 하나를 열었다고 그 제안을 채택하거나 나머지 모든 축을 확인해야 하는 것은 아닙니다. 라운드는 매번 같은 제안으로 끝납니다. "이대로"라고 하시면 여기서 중단하고 지금까지의 대화로 경계를 설정하고, 다른 답은 이어가거나 철회하거나 다른 필요를 가리킵니다.
...
- [SKILL.md](skills/bound/SKILL.md)는 잠정 구조의 발견, 점진적 검토, 출처에 따른 결정, 그리고 사용자의 "이대로"로 닫히는 수렴을 정의합니다. 이 정의는 elaborate 되는 Lean 4 블록입니다.
