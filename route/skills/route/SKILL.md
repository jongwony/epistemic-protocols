...
── TYPES ──
C  = AccumulatedContext   -- the session at this invocation, including evidence recognized during the current turn; any protocol whose checkpoint stood at the prompt has first read that prompt by its own contract
