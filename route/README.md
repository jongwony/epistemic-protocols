...
| One finding line in the transcript (`↗ /command — reason`), no invocation, turn continues | A gate holds the user's judgment and a different protocol is the dominant match — monitor mode |
