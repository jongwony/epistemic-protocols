...
const PREMISE_INDEX = [
  ...
  { file: "tiering-and-scope.md", when: "when deciding where to state a principle, and when classifying whether a principle should matter more or less as the underlying model improves." },
