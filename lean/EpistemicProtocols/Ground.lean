...
/-! The GROUND section every protocol Lean block carries verbatim; lean-definition compares each
    copy against the text between this file's `namespace Ground` and `end Ground`. -/
