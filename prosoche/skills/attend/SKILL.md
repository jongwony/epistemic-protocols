...
11. **Convergence evidence**: as typed by the `Convergence evidence` statement in the LOOP block.
...
18. **Seam relay on declared continuation, enforcer edge excepted**: as typed by the "seam (extension)" entry in TOOL GROUNDING.
