...
19. **No silent risk dismissal**: If Phase 0 classifies all tasks as p=Low, present this classification with reasoning to user for confirmation before batch delegation — do not silently delegate all
