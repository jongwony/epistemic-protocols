...
The presentation is the story, the excerpts with their sources, the adjacent candidates, and the qualifications, and then the turn yields with no option list — what the person says next is read as identification, a stop, or more cue. The open question carries only the question. The expansion question puts what was searched before it and carries only the wider search and stopping here, each with its differential implication. Context embedded inside a question is context the person has to dig out of it.
