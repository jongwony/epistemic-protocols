...
8. **Convergence evidence**: as typed by the `Convergence evidence` statement in the LOOP block, with the SingleObvious Extension-path folding in the CONVERGENCE block's `recall_complete` equation.
