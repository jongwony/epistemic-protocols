...
2. **Recognition over Retrieval**: Present narrative candidates via gate interaction and yield turn — structured content reaches the user with response opportunity.
