...
Read [`instruction-authoring.md`](instruction-authoring.md) when writing or revising instructions and durable records, when judging whether a new rule earns its place and whether an entry already there still does, and when deciding how much to inline for a reader versus leaving as a reference.
